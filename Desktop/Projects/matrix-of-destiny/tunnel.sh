...
cp /mnt/host/c/Users/dell/Desktop/Projects/matrix-of-destiny/deploy_key "$KEY"
chmod 600 "$KEY"
PORT=$(cat /mnt/host/c/Users/dell/Desktop/Projects/matrix-of-destiny/.port | tr -d '[:space:]')
